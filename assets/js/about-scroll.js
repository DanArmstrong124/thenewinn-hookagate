...
window.onscroll = function() {
    ...
    if(scrollPosition >= 200){
        ...
        about.classList.add('par-nav-link-style-active');
        ...
        about.classList.remove('nav-link-style-active');
    ...
    if(scrollPosition <= 199){
        ...
        about.classList.remove('par-nav-link-style-active');
        ...
        about.classList.add('nav-link-style-active');
