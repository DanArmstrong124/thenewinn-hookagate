...
window.onscroll = function() {
    ...
    if(scrollPosition >= 200){
        ...
        gallery.classList.add('par-nav-link-style-active');
        ...
        gallery.classList.remove('nav-link-style-active');
    }
    ...
    if(scrollPosition <= 199){
        ...
        gallery.classList.remove('par-nav-link-style-active');
        ...
        gallery.classList.add('nav-link-style-active');
    };
};