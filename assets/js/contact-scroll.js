...
window.onscroll = function() {
    ...
    if(scrollPosition >= 200){
        ...
        contact.classList.add('par-nav-link-style-active');
        ...
        contact.classList.remove('nav-link-style-active');
    ...
    if(scrollPosition <= 199){
        ...
        contact.classList.remove('par-nav-link-style-active');
        ...
        contact.classList.add('nav-link-style-active');
